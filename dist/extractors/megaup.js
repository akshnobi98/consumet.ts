...
class MegaUp extends models_1.VideoExtractor {
    constructor() {
        ...
        this.Decode = (n) => {
            n = __classPrivateFieldGet(this, _MegaUp_reverseIt, "f").call(this, __classPrivateFieldGet(this, _MegaUp_substitute, "f").call(this, __classPrivateFieldGet(this, _MegaUp_transform, "f").call(this, 'fnxEj3tD4Bl0X', __classPrivateFieldGet(this, _MegaUp_base64UrlDecode, "f").call(this, __classPrivateFieldGet(this, _MegaUp_transform, "f").call(this, 'IjilzMV57GrnF', __classPrivateFieldGet(this, _MegaUp_base64UrlDecode, "f").call(this, __classPrivateFieldGet(this, _MegaUp_substitute, "f").call(this, __classPrivateFieldGet(this, _MegaUp_reverseIt, "f").call(this, __classPrivateFieldGet(this, _MegaUp_substitute, "f").call(this, __classPrivateFieldGet(this, _MegaUp_transform, "f").call(this, 'PlzI69YVCtGwoa8', __classPrivateFieldGet(this, _MegaUp_base64UrlDecode, "f").call(this, __classPrivateFieldGet(this, _MegaUp_reverseIt, "f").call(this, __classPrivateFieldGet(this, _MegaUp_base64UrlDecode, "f").call(this, (n = `${n}`))))), 'c2IfHZwSX1mj', 'mwfXcS2ZjI1H')), '82NkgQDYbIF', '82IQNkFgYbD'))))), 'crwkth05iJR8', 'JRkt8rw0i5ch'));
            return decodeURIComponent(n);
        };
